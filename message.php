...
<?php if(isset($_SESSION['delete-msg-success'])) : // shows if add user was successful ?>
            ...
            <?php elseif(isset($_SESSION['delete-msg'])) : // shows if edit user was Unsuccessful ?>
        ...
        <div class="message__card">
            ...
            while($m = mysqli_fetch_assoc($msg)) :?>
                <tr>
                    ...
                    <td class="this_td">
                        <a href="<?= ROOT_URL ?>message_delete-logic.php?msg_id=<?=$m['id']?>">
                            <i class="uil uil-trash-alt trash__icon"></i>
                        </a>
                    </td>
