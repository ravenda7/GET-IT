...
$total_records = mysqli_num_rows($categories);
...
$start = ($page - 1) * $limit;
$query_limit = "SELECT * FROM categories ORDER BY title LIMIT $start,$limit";
        ...
        <main>
            ...
            <?php if ($total_records > 0): ?>
                <table>
                    ...
                    <tbody>
                        <?php while ($category = mysqli_fetch_assoc($result_limit)): ?>
                            <?php if ($category['lock_category'] == 1): ?>
                                <tr>
                                    <td>
                                        <?= $category['title'] ?>
                                    </td>
                            ...
                            <?php else: ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= ROOT_URL ?>admin/edit-category.php?id=<?= $id ?>" class="btn sm">Edit</a>
                                    </td>
